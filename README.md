...
- A numerical estimated bite-time range based on vanilla's random wait bounds, Lure, rain, and sky exposure; it changes to `Coming` only for the verified approach trail and never substitutes `Soon`.
